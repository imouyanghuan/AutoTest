...
import com.tchip.autotest.ViewFileActivity.ViewFileEntry;
...
public class ViewFileAdapter extends BaseAdapter {
	...
	@Override
	public View getView(int position, View convertView, ViewGroup parent) { // by
																			// zxx
		ViewHolder myViews;
		if (convertView == null) {
			myViews = new ViewHolder();
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.list_file_item_body, parent, false);
