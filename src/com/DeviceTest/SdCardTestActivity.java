...
public class SdCardTestActivity extends Activity {
	...
	private boolean dotestReadAndWrite() {
		...
		if (!directory.isDirectory()) {
			if (!directory.mkdirs()) {
				sBuilder.append(getString(R.string.MakeDir) + FAIL)
						.append("\n");
				return false;
			} else {
	 ...
	 * String newState) { if (path.equals(DeviceTest.sdcard_path) &&
	 * newState.equals(Environment.MEDIA_MOUNTED)) { testSdcard();
	 * testReadAndWrite(); } } };
	 */
